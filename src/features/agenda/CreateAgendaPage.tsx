  ...
  return (
    <main className="flex-1">
      <div className="mx-auto min-h-screen max-w-4xl">
        ...
        {isSuccess ? (
          <div className="mb-5 flex items-center justify-between border border-emerald-200 bg-emerald-50 p-4 text-xs font-semibold text-emerald-800">
            <div className="flex items-center gap-2">
              ...
              <span>
                {state?.message || "Agenda kegiatan baru berhasil disimpan!"}
              </span>
            </div>
            <Link
        ...
        {errorList.length > 0 ? (
          <div className="mb-5 border border-rose-200 bg-rose-50/80 p-4 text-left">
            <div className="mb-2 flex items-center gap-2">
              ...
              <h4 className="text-xs font-bold tracking-wider text-rose-900 uppercase">
                Terdapat kesalahan masukan formulir ({errorList.length})
              </h4>
            </div>
            <ul className="list-inside list-disc space-y-1 pl-1 text-xs font-medium text-rose-800">
        ...
        <form
          action={formAction}
          className="space-y-5 border border-zinc-200 bg-white p-4"
        >
          {/* TITLE */}
          <div className="space-y-1.5">
            ...
            <input
              ...
              defaultValue=""
              className="w-full border border-slate-200 bg-slate-50/50 px-3.5 py-2.5 text-xs font-medium text-slate-900 transition-colors outline-none focus:border-emerald-500 focus:bg-white focus:ring-1 focus:ring-emerald-500"
            />
          </div>
